...
After obtaining the model, we will use cross validation with a training set to estimate the error rate of the model.
...
There is approximately 22 % error in the prediction of high alcohol use using this model.
